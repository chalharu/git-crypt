...
**Key dependencies:** `clap`, `git2`, `pgp`
...
```
src/main.rs             CLI entrypoint and core behavior
src/tests/              Rust tests for clean/smudge/merge flows
.github/hooks/          Copilot post-tool hook automation
.github/workflows/      CI, release, and delivery automation
```
